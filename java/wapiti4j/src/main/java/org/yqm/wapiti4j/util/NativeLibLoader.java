...
public class NativeLibLoader {
    ...
    private static final String nativeResourcePath = "/lib/native/";
    private static final String[] libNames = new String[]{"wapiti4j"};

    public static synchronized void initWapiti() throws IOException {
        if (!initialized) {
